...
import net.wenzuo.mono.mybatisplus.config.MonoMybatisPlusAutoConfiguration;
...
class ApplicationTests {
    ...
    @Test
    void contextLoads() {
        Assertions.assertNotNull(applicationContext.getBean(MonoMybatisPlusAutoConfiguration.class));
